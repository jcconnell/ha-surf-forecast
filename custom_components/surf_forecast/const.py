...
# past 90 degrees keeps grazing angles and refraction from raising false alarms.
SHORE_CHECK_MAX_OFFSET = 100.0
SHORE_CHECK_MIN_HOURS = 12
SHORE_CHECK_MIN_COHERENCE = 0.5
ISSUE_SHORE_DIRECTION = "shore_direction_suspect"
